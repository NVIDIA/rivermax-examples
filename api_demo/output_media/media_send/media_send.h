 ...
 */
#ifndef API_DEMO_OUTPUT_MEDIA_MEDIA_SEND_H_
#define API_DEMO_OUTPUT_MEDIA_MEDIA_SEND_H_
...
constexpr const char* APP_EXAMPLES = \
    "Examples:\n"
    "  1. rmx_media_send_demo_app --local-ip 1.2.3.4\n"
    "  2. rmx_media_send_demo_app --local-ip 1.2.3.4 --dst-ip 231.1.2.3 --dst-port 60000";
...
#endif // API_DEMO_OUTPUT_MEDIA_MEDIA_SEND_H_
