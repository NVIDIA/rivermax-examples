 ...
 */
#ifndef API_DEMO_OUTPUT_MEDIA_MEMORY_REGISTRATION_MEDIA_SEND_H_
#define API_DEMO_OUTPUT_MEDIA_MEMORY_REGISTRATION_MEDIA_SEND_H_
...
#endif // API_DEMO_OUTPUT_MEDIA_MEMORY_REGISTRATION_MEDIA_SEND_H_
