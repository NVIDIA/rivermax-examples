 ...
 */
#ifndef API_DEMO_INPUT_DRAIN_DETACHED_FLOW_RECEIVE_H_
#define API_DEMO_INPUT_DRAIN_DETACHED_FLOW_RECEIVE_H_
...
constexpr const char* APP_DESCRIPTION = "NVIDIA Rivermax API Drain Detached Flow Demo App";
constexpr const char* APP_EXAMPLES = \
    "Example:\n"
    "  rmx_drain_detached_flow_receive_demo_app --local-ip 1.2.3.4 --src-ip 1.2.10.1 --dst-ips 231.1.2.3,231.1.2.4 --dst-ports 2001,2002";

/**
 * @brief Rivermax Input API Drain Detached Flow Demo App.
 *
 ...
 */
class RmxDrainDetachedFlowDemoApp : public RmxAPIBaseDemoApp
{
public:
    RmxDrainDetachedFlowDemoApp();
    virtual ~RmxDrainDetachedFlowDemoApp() = default;
protected:
...
#endif // API_DEMO_INPUT_DRAIN_DETACHED_FLOW_RECEIVE_H_
